...
# Train BPE
echo "Training BPE..."
subword-nmt learn-joint-bpe-and-vocab --input $DATA/$TRAIN_PREFIX.tok.nofact.$SRC_LANG $DATA/$TRAIN_PREFIX.tok.$TGT_LANG -s 32000 -o $DATA/$SRC_LANG$TGT_LANG.bpe --write-vocabulary $DATA/vocab.bpe.$SRC_LANG $DATA/vocab.bpe.$TGT_LANG
...
echo "Creating vocab..."
cat $DATA/$TRAIN_PREFIX.tok.nofact.bpe.$SRC_LANG $DATA/$TRAIN_PREFIX.tok.bpe.$TGT_LANG | $MARIAN/marian-vocab > $DATA/vocab.$SRC_LANG$TGT_LANG.yml
